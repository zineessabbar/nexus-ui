...
const SessionBlankState = () => {
  const { selectedEndpoint, isEndpointActive, agentId } = useStore()
    ...
    <div className="mt-1 flex items-center justify-center rounded-lg bg-background-secondary/50 pb-6 pt-4">
      <div className="flex flex-col items-center gap-1">
        ...
        <div className="flex flex-col items-center gap-2">
          <h3 className="text-sm font-medium text-slate-800">No Session found</h3>
          <p className="max-w-[210px] text-center text-sm text-slate-500">
            {errorMessage}
          </p>
        </div>
      </div>
